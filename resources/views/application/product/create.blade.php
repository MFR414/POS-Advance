                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('application.products.store') }}" method="POST" style="margin-bottom: 0">
                                {{ csrf_field() }}
                                <section>
                                    <div class="row">
                                        <div class="col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control boxed" name="code" value="{{ old('code') }}" placeholder="Masukkan Kode Produk">
                                                @error('code')
                                        ...
                                        <div class="col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control underlined" name="name" value="{{ old('name') }}" placeholder="Masukkan Nomor Telefon Admin">
                                                @error('name')
                                                    <span class="has-error">
                                                        {{ $message }}
                                                    </span>
                                        ...
                                        <div class="col-sm-12 col-md-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control underlined" name="price" value="{{ old('price') }}" id="price">
                                                @error('price')
                                        ...
                                        <div class="col-sm-12 col-md-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control underlined" name="initial_stock" value="{{ old('initial_stock') }}" placeholder="Masukkan stok awal produk">
                                                @error('initial_stock')
                                                    <span class="has-error">
                                                        {{ $message }}
                                                    </span>
